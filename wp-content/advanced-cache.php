...
// WP-Optimize advanced-cache.php (written by version: 4.2.1) (homeurl: http://localhost:8080/) (abspath: /var/www/html/) (do not change this line, it is used for correctness checks)
...
if (false === $plugin_location) {
	...
	if (strcasecmp('http://localhost:8080/', $protocol . '://' . $host . $request_uri) === 0) {
